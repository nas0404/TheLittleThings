...
class GoalServiceTest {
  ...
  void setUp() {
    ...
    service = new GoalService(goalRepo, userRepo, categoryRepo);
  }
  ...
  void create_success() {
    ...
    var user = new User(); user.setUserId(userId);
    var cat = new Category(); cat.setCategoryId(catId); cat.setUser(user);
  ...
  void create_categoryWrongOwner_400() {
    ...
    var otherUser = new User(); otherUser.setUserId(99L);
    var cat = new Category(); cat.setCategoryId(catId); cat.setUser(otherUser);
  ...
  void listByUser_success() {
    ...
    var cat = new Category(); cat.setCategoryId(4L); cat.setUser(user);

    var g1 = new Goal(); g1.setGoalId(1L); g1.setUser(user); g1.setCategory(cat); g1.setTitle("A"); g1.setPriority("HIGH");
    var g2 = new Goal(); g2.setGoalId(2L); g2.setUser(user); g2.setCategory(cat); g2.setTitle("B"); g2.setPriority("LOW");
  ...
  void getOwnedGoal_wrongOwner_404() {
    var owner = new User(); owner.setUserId(31L);
    var other = new User(); other.setUserId(77L);
    var cat = new Category(); cat.setCategoryId(4L); cat.setUser(owner);

    var goal = new Goal(); goal.setGoalId(9L); goal.setUser(owner); goal.setCategory(cat); goal.setTitle("t");
  ...
  void update_priorityValidation_400() {
    ...
    var goal = new Goal(); goal.setGoalId(5L); goal.setUser(user); goal.setCategory(cat);
    goal.setTitle("Old"); goal.setPriority("LOW");
  ...
  void delete_success() {
    var user = new User(); user.setUserId(31L);
    var cat = new Category(); cat.setCategoryId(4L); cat.setUser(user);
    var goal = new Goal(); goal.setGoalId(7L); goal.setUser(user); goal.setCategory(cat);
